...
int main(int argc, char** argv) {
	int height, width, n_height, n_width, frame_width, frame_hight, c = 0, max = 30;
	int x, y, xx, yy;
	...
	VideoWriter video("sobel.avi", cv::VideoWriter::fourcc('M', 'J', 'P', 'G'), 10, Size(frame_width, frame_hight));
